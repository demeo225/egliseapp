...
var $cellule = $('#presencecellule_cellule');
...
$cellule.change(function() {
  ...
  $.ajax({
    ...
    complete: function(html) {
      ...
      $('#presencecellule_fidele').replaceWith(
        // ... with the returned one from the AJAX response.
        $(html.responseText).find('#presencecellule_fidele')
      );
...
$cellule.change(function() {
  ...
  $.ajax({
    ...
    complete: function(html) {
      // Replace current fidele field ...
      $('#presencecellule_seancecellule').replaceWith(
        // ... with the returned one from the AJAX response.
        $(html.responseText).find('#presencecellule_seancecellule')
      );
      // Position field now displays the appropriate fideles.
    }
  });
