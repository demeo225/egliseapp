...
class InvitezoneType extends AbstractType {

    public function buildForm(FormBuilderInterface $builder, array $options): void {
        $seancezone = $options['seancezone'];
        ...
        $builder
                ...
                ->add('fonction')
                ->add('seancezone', EntityType::class, [
                    'class' => Seancezone::class,
                    'choices' => $seancezone,
