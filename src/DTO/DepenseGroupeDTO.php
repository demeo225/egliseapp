...
class DepenseGroupeDTO
{
    ...
    private function calculerStatistiques(): void
    {
        ...
        foreach ($this->depenses as $depense) {
            ...
            $groupeNom = $depense->getGroupe() ? $depense->getGroupe()->getNom() : 'Non défini';
            ...
            $this->statistiquesParGroupe[$groupeNom]['nombre_depenses']++;
            $this->statistiquesParGroupe[$groupeNom]['montant_total'] += $montant;
