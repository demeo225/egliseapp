...
/**
 * @ORM\Entity(repositoryClass=DepensecodimRepository::class)
 */
class Depensecodim extends AbstractEntity
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Eglise::class, inversedBy="depensecodims")
     */
    private $eglise;
