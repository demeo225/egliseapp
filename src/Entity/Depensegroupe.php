...
/**
 * @ORM\Entity(repositoryClass=DepensegroupeRepository::class)
 */
class Depensegroupe  extends AbstractEntity
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Groupe::class, inversedBy="depensegroupes")
     */
    private $groupe;
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Eglise::class, inversedBy="depensegroupes")
     */
    private $eglise;
