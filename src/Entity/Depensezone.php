...
/**
 * @ORM\Entity(repositoryClass=DepensezoneRepository::class)
 */
class Depensezone  extends AbstractEntity
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Zone::class, inversedBy="depensezones")
     */
    private $zone;
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Eglise::class, inversedBy="depensezones")
     */
    private $eglise;
