...
/**
 * @ORM\Entity(repositoryClass=DetailcotisationgroupeRepository::class)
 */
class Detailcotisationgroupe  extends AbstractEntity
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Cotisationgroupe::class)
     */
