...
/**
 * @ORM\Entity(repositoryClass=CotiserpazoneRepository::class)
 */
class Cotiserpazone extends AbstractEntity
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Zone::class, inversedBy="cotiserpazones")
     */
    private $zone;
  

    /**
     * @ORM\ManyToOne(targetEntity=Cotisationparzone::class, inversedBy="cotiserpazones")
     */
    private $cotisationparzone;

    /**
     * @ORM\ManyToOne(targetEntity=Eglise::class, inversedBy="cotiserpazones")
     */
    private $eglise;
