...
/**
 * @ORM\Entity(repositoryClass=DimeRepository::class)
 */
class Dime extends AbstractEntity
{
    /**
     * @ORM\Id
     * @ORM\GeneratedValue
   ...
   /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Fidele::class, inversedBy="dimes")
     */
    private $fidele;
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Eglise::class, inversedBy="dime")
     */
    private $eglise;
        /**
    ...
    public function getDatedime(): ?\DateTimeInterface
    {
        return $this->datedime;
    }

    public function setDatedime(?\DateTimeInterface $datedime): self
    {
        $this->datedime = $datedime;
