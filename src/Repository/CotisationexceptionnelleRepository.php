...
/**
 * @method Cotisationexceptionnelle|null find($id, $lockMode = null, $lockVersion = null)
 * @method Cotisationexceptionnelle|null findOneBy(array $criteria, array $orderBy = null)
 * @method Cotisationexceptionnelle[]    findAll()
 * @method Cotisationexceptionnelle[]    findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class CotisationexceptionnelleRepository extends ServiceEntityRepository {

    public function __construct(ManagerRegistry $registry) {
        parent::__construct($registry, Cotisationexceptionnelle::class);
    }

    // /**
    //  * @return Cotisationexceptionnelle[] Returns an array of Cotisationexceptionnelle objects
    //  */
    /*
    ...
    /*
      public function findOneBySomeField($value): ?Cotisationexceptionnelle
      {
      return $this->createQueryBuilder('c')
      ->andWhere('c.exampleField = :val')
      ->setParameter('val', $value)
    ...
    public function rechercheCotisationException($criteria = [], DateTime $dateDebut = null, DateTime $dateFin = null, $limit = NULL) {
        try {
...
//            $qb->addOrderBy('enf.date2', 'DESC');
            ...
            if ($dateDebut && $dateFin) {
                $qb
                        ->andWhere('enf.datecotise BETWEEN :dateDebut AND :dateFin')
    ...
    public function rechercheCotisationExceptionn($criteria = [], DateTime $dateDebut = null, DateTime $dateFin = null, $limit = NULL) {
        try {
            $qb = $this->createQueryBuilder('enf');
