...
/**
 * @method Dimeglobale|null find($id, $lockMode = null, $lockVersion = null)
 * @method Dimeglobale|null findOneBy(array $criteria, array $orderBy = null)
 * @method Dimeglobale[]    findAll()
 * @method Dimeglobale[]    findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class DimeglobaleRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, Dimeglobale::class);
    }

    // /**
    //  * @return Dimeglobale[] Returns an array of Dimeglobale objects
    //  */
    /*
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?Dimeglobale
    {
        return $this->createQueryBuilder('d')
            ->andWhere('d.exampleField = :val')
            ->setParameter('val', $value)
    ...
    */
         ...
         public function rechercheDimeGlobale($criteria = [], DateTime $dateDebut = null, DateTime $dateFin = null, $limit = NULL) {
        try {
...
//            $qb->addOrderBy('enf.date2', 'DESC');
            ...
            if ($dateDebut && $dateFin) {
                $qb
                        ->andWhere('enf.datedime BETWEEN :dateDebut AND :dateFin')
       ...
       public function rechercheDimeGlobalen($criteria = [], DateTime $dateDebut = null, DateTime $dateFin = null, $limit = NULL) {
        try {
            $qb = $this->createQueryBuilder('enf');
