...
class DecesRepository extends ServiceEntityRepository
{
    ...
    */
      ...
      public function rechercheDeces($criteria = [], DateTime $dateDebut = null, DateTime $dateFin = null, $limit = NULL) {
        try {
            ...
            if ($dateDebut && $dateFin) {
                $qb
                        ->andWhere('enf.datedeces BETWEEN :dateDebut AND :dateFin')
       ...
       public function rechercheDecesn($criteria = [], DateTime $dateDebut = null, DateTime $dateFin = null, $limit = NULL) {
        try {
            $qb = $this->createQueryBuilder('enf');
