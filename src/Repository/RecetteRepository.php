...
class RecetteRepository extends ServiceEntityRepository
{
    ...
    */
    ...
    public function rechercheRecette($criteria = [], DateTime $dateDebut = null, DateTime $dateFin = null, $limit = NULL) {
        try {
...
//            $qb->addOrderBy('enf.date2', 'DESC');
            ...
            if ($dateDebut && $dateFin) {
                $qb
                        ->andWhere('enf.daterecette BETWEEN :dateDebut AND :dateFin')
           ...
           public function rechercheRecetten($criteria = [], DateTime $dateDebut = null, DateTime $dateFin = null, $limit = NULL) {
        try {
            $qb = $this->createQueryBuilder('enf');
            ...
            if (array_key_exists('objetrecette', $criteria)) {

                $qb->andWhere("enf.objetrecette = :objetrecette");
                $qb->setParameter('objetrecette', $criteria['objetrecette']);
                unset($criteria['objetrecette']);
            }
