...
class CongeRepository extends ServiceEntityRepository {
    ...
    public function rechercheConge($criteria = [], DateTime $dateDebut = null, DateTime $dateFin = null, $limit = NULL) {
        try {
            ...
            if ($dateDebut && $dateFin) {
                $qb
                        ->andWhere('enf.dateconge BETWEEN :dateDebut AND :dateFin')
           ...
           public function rechercheCongen($criteria = [], DateTime $dateDebut = null, DateTime $dateFin = null, $limit = NULL) {
        try {
            $qb = $this->createQueryBuilder('enf');
