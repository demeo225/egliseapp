...
class DisciplineRepository extends ServiceEntityRepository
{
    ...
    */
         ...
         public function rechercheDiscipline($criteria = [], DateTime $dateDebut1 = null, DateTime $dateFin = null, $limit = NULL) {
        try {
            ...
            if ($dateDebut1 && $dateFin) {
                $qb
                        ->andWhere('enf.datedebut BETWEEN :dateDebut1 AND :dateFin')
           ...
           public function rechercheDisciplinen($criteria = [], DateTime $dateDebut1 = null, DateTime $dateFin = null, $limit = NULL) {
        try {
            $qb = $this->createQueryBuilder('enf');
