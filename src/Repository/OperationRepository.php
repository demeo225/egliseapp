...
class OperationRepository extends ServiceEntityRepository {
    ...
    public function rechercheOperation($criteria = [], DateTime $dateDebut = null, DateTime $dateFin = null, $limit = NULL) {
        try {
...
//            $qb->addOrderBy('enf.date2', 'DESC');
            ...
            if (array_key_exists('objet', $criteria)) {

                $qb->andWhere("enf.objet = :objet");
                $qb->setParameter('objet', $criteria['objet']);
                unset($criteria['objet']);
            }
           ...
           public function rechercheOperationn($criteria = [], DateTime $dateDebut = null, DateTime $dateFin = null, $limit = NULL) {
        try {
            $qb = $this->createQueryBuilder('enf');
