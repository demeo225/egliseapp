...
/**
 * @method Seancezone|null find($id, $lockMode = null, $lockVersion = null)
 * @method Seancezone|null findOneBy(array $criteria, array $orderBy = null)
 * @method Seancezone[]    findAll()
 * @method Seancezone[]    findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class SeancezoneRepository extends ServiceEntityRepository
{
    public function __construct(ManagerRegistry $registry)
    {
        parent::__construct($registry, Seancezone::class);
    }
     ...
     */
    public function add(Seancezone $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(Seancezone $entity, bool $flush = true): void
    {
    ...
    // /**
    //  * @return Seancezone[] Returns an array of Seancezone objects
    //  */
    /*
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?Seancezone
    {
        return $this->createQueryBuilder('s')
            ->andWhere('s.exampleField = :val')
            ->setParameter('val', $value)
    ...
    */
    ...
    public function rechercheZone($criteria = [], DateTime $dateDebut = null, DateTime $dateFin = null, $limit = NULL) {
        try {
...
//              $qb->join('App\Entity\Cellule', 'four', Join::WITH, 'enf.zone = four.id');
...
//            $qb->addOrderBy('enf.date2', 'DESC');
            ...
            //SI on a zone dans les critere de recherche
