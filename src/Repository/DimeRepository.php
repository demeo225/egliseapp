...
/**
 * @method Dime|null find($id, $lockMode = null, $lockVersion = null)
 * @method Dime|null findOneBy(array $criteria, array $orderBy = null)
 * @method Dime[]    findAll()
 * @method Dime[]    findBy(array $criteria, array $orderBy = null, $limit = null, $offset = null)
 */
class DimeRepository extends ServiceEntityRepository {

    public function __construct(ManagerRegistry $registry) {
        parent::__construct($registry, Dime::class);
    }

    // /**
    //  * @return Dime[] Returns an array of Dime objects
    //  */
    /*
    ...
    /*
      public function findOneBySomeField($value): ?Dime
      {
      return $this->createQueryBuilder('d')
      ->andWhere('d.exampleField = :val')
      ->setParameter('val', $value)
    ...
    public function rechercheDime($criteria = [], DateTime $dateDebut = null, DateTime $dateFin = null, $limit = NULL) {
        try {
...
//            $qb->addOrderBy('enf.date2', 'DESC');
           ...
           public function rechercheDimen($criteria = [], DateTime $dateDebut = null, DateTime $dateFin = null, $limit = NULL) {
        try {
            $qb = $this->createQueryBuilder('enf');
    ...
    public function getDimeByDates() {
        return $this->createQueryBuilder('m')
                        ->select('DISTINCT m.datedime')
                        ->where('m.deletedAt IS  NULL')
                        ->orderBy('m.datedime', 'DESC')
                        ->getQuery()
                        ->getResult();
    }
